cask 'intel-psxe-ce-c++' do
  ...
  name 'Intel Parallel Studio XE Composer Edition for C++ macOS'
  homepage 'https://software.intel.com/en-us/parallel-studio-xe'

  installer manual: "m_ccompxe_#{version}.app"

  uninstall script: { executable: "m_ccompxe_#{version}.app/Contents/MacOS/uninstall.sh", args: ['--silent'], sudo: true }
