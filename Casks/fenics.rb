  ...
  caveats do
    <<-EOS.undent
      ...
      file in your home directory:
        ...
        source #{Hbx.appdir}/FEniCS.app/Contents/Resources/share/fenics/fenics.conf
      ...
      Creating a new shell using the following command works well:
        ...
        /bin/bash --rcfile #{Hbx.appdir}/FEniCS.app/Contents/Resources/share/fenics/fenics.conf
    EOS
  end
end
