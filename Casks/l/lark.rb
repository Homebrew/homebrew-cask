cask "lark" do
  ...
  url "https://lf16-larkappversion-sign.larksuitecdn.com/obj/lark-artifact-storage/#{version.csv.second}/Lark-darwin_#{arch}-#{version.csv.first}-signed.dmg",
      verified: "lf16-larkappversion-sign.larksuitecdn.com/obj/lark-artifact-storage/"
  name "Lark"
