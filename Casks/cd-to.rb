cask 'cd-to' do
  ...
  url "https://github.com/jbtule/cdto/releases/download/#{version.gsub('.', '_')}/cdto_#{version.gsub('.', '_').gsub(%r{_\d$}, '')}.zip"
  ...
  app "cdto_#{version.gsub('.', '_').gsub(%r{_\d$}, '')}/terminal/cd to.app"
