cask "decentr" do
  ...
  on_arm   { sha256 "a15e91def4242b950b23f46dd2d0a18e2348c5f0c7e030b82e4acdcb301c1511" }
  on_intel { sha256 "9429047b44478fcc6bc48ac5bca73f9064a992e3b07c6ad33a8868f5cfa6d375" }
  ...
  livecheck do
    url :homepage
    regex(/href=.*?MacOS_#{arch}_Decentr_v?(\d+(?:\.\d+)+)\.zip/i)
  end
