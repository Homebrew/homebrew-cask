cask "copytranslator" do
  ...
  # https://github.com/CopyTranslator/CopyTranslator/ was verified as official when first introduced to the cask
  ...
  name "CopyTranslator"
  desc "A tool that translates text in real-time while copying"
