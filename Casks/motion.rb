cask 'motion' do
  ...
  # github.com/philipardeljan/getmotion/releases/download/ was verified as official when first introduced to the cask
  ...
  name 'Motion – Free, simple animated SVG editor.'
