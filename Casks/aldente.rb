cask "aldente" do
  ...
  uninstall quit: "com.davidwernhart.Helper", delete: "/Library/PrivilegedHelperTools/com.davidwernhart.Helper"

  zap trash: "/Library/LaunchDaemons/com.davidwernhart.Helper.plist"
end
