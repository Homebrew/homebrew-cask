cask 'maciasl' do
  if MacOS.release == :lion
    ...
    url "https://downloads.sourceforge.net/sourceforge/maciasl/#{version}/MaciASL_Lion.zip"
  else
    version '1.4'
    sha256 '24c0dbaa9a13231b8c8e364ef0e6d60656718320ce69d8bb23aa5bc27e82e87d'

    url "https://downloads.sourceforge.net/sourceforge/maciasl/#{version}/MaciASL.zip"
  end
