cask 'jabber-video' do
  ...
  postflight do
    ...
    system '/bin/rm', '--', "#{Hbc.appdir}/Jabber Video.app/Contents/Resources/ForcedConfig.plist"
  end
  ...
  zap delete: [
      ...
      script: "#{Hbc.appdir}/Jabber Video.app/Contents/SharedSupport/remove_user_data.sh"
end
