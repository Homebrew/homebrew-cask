cask "prettyclean" do
  ...
  framework = on_arch_conditional arm: "aarch64", intel: "x64"
  ...
  url "https://downloads.jmotor.org/prettyclean/v#{version}/darwin-#{arch}/PrettyClean_#{version}_#{framework}.dmg",
  ...
  livecheck do
    ...
    regex(/href=.*?PrettyClean[._-]v?(\d+(?:\.\d+)+)[._-]#{framework}\.dmg/i)
