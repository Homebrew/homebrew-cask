cask 'mnemosyne' do
  ...
  url "https://downloads.sourceforge.net/project/mnemosyne-proj/mnemosyne/mnemosyne-#{version}/Mnemosyne-#{version}.dmg"
  appcast 'https://sourceforge.net/p/mnemosyne-proj/activity/feed?source=project_activity',
