cask "vmware-horizon-client" do
  ...
  livecheck do
    url "https://my.vmware.com/channel/public/api/v1.0/dlg/details?locale=en_US&downloadGroup=#{version.after_comma}_MAC_2103"
    strategy :page_match
    regex(%r{href=.*?/VMware-Horizon-Client-(\d+(?:\.\d+)*)\.dmg}i)
  end
