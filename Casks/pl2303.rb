class Pl2303 < Cask 
  ...
  url 'http://prolificusa.com/files/md_PL2303_MacOSX-10_6up_v1_5_1.zip'
  homepage 'http://www.prolificusa.com'
  license :closed 

 pkg 'PL2303_MacOSX_v1.5.1.pkg'
 uninstall :delete => ['/System/Library/Extensions/ProlificUsbSerial.kext',
