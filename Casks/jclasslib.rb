cask 'jclasslib' do
  ...
  url "https://github.com/ingokegel/jclasslib/releases/download/5.1/jclasslib_macos_5_1.dmg"
  ...
  zap delete: [
                '~/Library/Saved Application State/com.install4j.8931-3388-4457-4383.404488187.savedState',
              ]
end
