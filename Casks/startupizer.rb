cask "startupizer" do
  ...
  url "https://dl.devmate.com/com.gentlebytes.Startupizer2/#{version.after_comma.before_colon}/#{version.after_colon}/Startupizer#{version.before_comma}-#{version.after_comma.before_colon}.zip",
      verified: "dl.devmate.com/com.gentlebytes.Startupizer2/"
