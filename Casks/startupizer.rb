cask 'startupizer' do
  ...
  url "https://dl.devmate.com/com.gentlebytes.Startupizer2/#{version.after_comma.before_colon}/#{version.after_colon}/Startupizer2-#{version.after_comma.before_colon}.zip"
  appcast 'https://updates.devmate.com/com.gentlebytes.Startupizer2.xml',
