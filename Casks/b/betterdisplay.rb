  ...
  on_ventura :or_newer do
    on_sequoia :or_older do
      ...
      livecheck do
        ...
        strategy :sparkle do |items|
          items.find { |item| item.channel.nil? && item.minimum_system_version <= :sequoia }&.short_version
        end
      end
    end
    on_tahoe :or_newer do
      ...
      livecheck do
        url "https://betterdisplay.pro/betterdisplay/sparkle/appcast.xml"
        strategy :sparkle do |items|
          items.find { |item| item.channel.nil? && item.minimum_system_version >= :tahoe }&.short_version
        end
      end
    end
  end
