cask 'royal-tsx' do
  ...
  # royaltsx-v2.royalapplications.com/updates/ was verified as official when first introduced to the cask
  url "https://royaltsx-v2.royalapplications.com/updates/royaltsx_#{version}.dmg"
