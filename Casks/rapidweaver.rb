cask 'rapidweaver' do
  ...
  url "https://dl.devmate.com/com.realmacsoftware.rapidweaver/#{version.after_comma.before_comma}/#{version.after_comma.after_comma}/RapidWeaver-#{version.after_comma.before_comma}.zip"
