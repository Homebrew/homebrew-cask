cask 'knotes' do
  ...
  # knotes#{version.major}.s3-ap-northeast-1.amazonaws.com/ was verified as official when first introduced to the cask
  url "https://knotes#{version.major}.s3-ap-northeast-1.amazonaws.com/download/mac/Knotes-#{version}.dmg"
