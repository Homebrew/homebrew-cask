cask 'zalo' do
  ...
  # res-download-pc-te-vnno-zn-2.zadn.vn/mac was verified as official when first introduced to the cask
  url "https://res-download-pc-te-vnno-zn-2.zadn.vn/mac/ZaloSetup-#{version}.dmg"
  name 'Zalo'
