cask "quarkclouddrive" do
  ...
  url "https://umcdn.quark.cn/download/37213/quarkclouddrivemac/pckk@app_downloader_fail_#{arch}/QuarkCloudDriveMac_V#{version.csv.first}_mac_pf30003_(zh-cn)_abi#{arch}_(Build#{version.csv.second}).dmg"
  ...
  livecheck do
    url "https://download.quark.cn/download/quarkclouddrivemac?platform=mac&ch=pckk@app_downloader_fail_#{arch}"
    regex(%r{
      /download/37213/quarkclouddrivemac/
      pckk@app_downloader_fail_#{arch}/
