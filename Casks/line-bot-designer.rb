cask 'line-bot-designer' do
  ...
  # d.line-scdn.net was verified as official when first introduced to the ca
  url 'https://d.line-scdn.net/r/devcenter/bot-designer/LINE%20Bot%20Designer-1.0.0.dmg'
