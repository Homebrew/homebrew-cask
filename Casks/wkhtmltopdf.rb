cask 'wkhtmltopdf' do
  ...
  if Hardware::CPU.is_32_bit?
    ...
    url "http://download.gna.org/wkhtmltopdf/0.12/#{version}/wkhtmltox-#{version}_osx-carbon-i386.pkg"
  else
    sha256 'c8aa0f9456444847d08c6c772e2e0e4244813e6a2911eba6c940439df9abd0f0'
    pkg "wkhtmltox-#{version}_osx-cocoa-x86-64.pkg"
    url "http://download.gna.org/wkhtmltopdf/0.12/#{version}/wkhtmltox-#{version}_osx-cocoa-x86-64.pkg"
  end
