cask "unifi-os-server" do
  version "5.0.6,b290,a165bb5f-f865-476a-b4bd-703e0d3d4ca1"
  sha256 "8e030977c6bf4e9c1e2e65ee3afd71033b67264167cf50add3fad48ab9544d40"

  url "https://fw-download.ubnt.com/data/unifi-os-server/#{version.csv.second}-macOS-dmg-amd64-#{version.csv.first}-#{version.csv.third}.dmg",
