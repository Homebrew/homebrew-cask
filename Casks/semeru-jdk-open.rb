cask "semeru-jdk-open" do
  ...
  url "https://github.com/ibmruntimes/semeru#{version.major}-binaries/releases/download/jdk-#{version.before_comma}_#{version.after_comma}/ibm-semeru-open-jdk_x64_mac_#{version.before_comma}_#{version.after_comma}.pkg",
  ...
  livecheck do
    ...
    strategy :page_match do |page, regex|
      page.scan(regex)
        .map { |match| "#{match[0].gsub("_","+")},#{match[1]}"}
    end
  end
