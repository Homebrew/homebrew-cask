...
on_ventura :or_older do
    on_high_sierra :or_older do
      ...
      url "https://download.calibre-ebook.com/3.48.0/calibre-3.48.0.dmg"
    end
    on_mojave do
      version "5.44.0"
      sha256 "89d7772ba1b95d219b34e285353340a174a013e06b4d8ad370433b3b98c94ad4"
      url "https://download.calibre-ebook.com/5.44.0/calibre-5.44.0.dmg"
    end
    on_catalina do
      version "6.11.0"
      sha256 "d7c40f3f35ba9043c13303632526f135b2c4086471a5c09ceb8b397c55c076fa"
      url "https://download.calibre-ebook.com/6.11.0/calibre-6.11.0.dmg"
    end
    on_big_sur do
      version "6.29.0"
      sha256 "2f76428ae19617875c5725cd892751a80eb2acdda76e06cd19c2f21a63966998"
      url "https://download.calibre-ebook.com/6.29.0/calibre-6.29.0.dmg"
    end
    on_monterey do
      version "6.29.0"
      sha256 "2f76428ae19617875c5725cd892751a80eb2acdda76e06cd19c2f21a63966998"
    ...
    on_ventura do
      ...
      url "https://download.calibre-ebook.com/7.26.0/calibre-7.26.0.dmg"
    end
