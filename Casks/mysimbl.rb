cask 'mysimbl' do
  ...
  url 'https://raw.githubusercontent.com/w0lfschild/app_updates/master/mySIMBL/mySIMBL_0.2.6.zip'
  ...
  caveats 'System Integrity Protection must be disabled for installing SIMBL.'
end
