cask 'art-of-illusion' do
  ...
  # sourceforge.net/sourceforge/aoi was verified as official when first introduced to the cask
  url "https://downloads.sourceforge.net/sourceforge/aoi/ArtOfIllusion#{version.no_dots}-Mac.dmg"
