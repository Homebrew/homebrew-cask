cask "chimera" do
  ...
  url "https://www.cgl.ucsf.edu/chimera/cgi-bin/secure/chimera-get.py?ident=OHeQer2WTaxn%2F%2BtrtntD5OBguUNERNj83x903g7ihe4rqA%3D%3D&file=mac64%2Fchimera-#{version}-mac64.dmg&choice=Notified"
  name "Chimera"
