cask 'send-to-kindle' do
  ...
  # s3.amazonaws.com/sendtokindle/SendToKindleForMac-installer.pkg was verified as official when first introduced to the cask
  ...
  uninstall pkgutil: 'com.amazon.SendToKindleMacInstaller.pkg'
end
