cask 'cathode' do
  ...
  # cjcaufield.s3.amazonaws.com was verified as official when first introduced to the cask
  url "https://cjcaufield.s3.amazonaws.com/products/cathode/cathode_#{version.no_dots}.zip"
