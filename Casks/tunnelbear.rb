cask "tunnelbear" do
  ...
  on_big_sur :or_newer do
    version "5.0.2,3000000002"
    sha256 "ed324352fdfdb8c3f94d58a48d3f1283b9a3592359ea3decfd674d2e3e6adaf0"
  end

  url "https://s3.amazonaws.com/tunnelbear/downloads/mac/TunnelBear-#{version.csv.first}.zip",
