cask "inform" do
  ...
  url "https://github.com/ganelson/inform/releases/download/v#{version}/Inform_#{version.dots_to_underscores}_macOS_1_82_1.dmg", verified: "github.com/ganelson/inform"
  name "Inform"
