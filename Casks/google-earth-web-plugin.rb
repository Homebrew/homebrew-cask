cask 'google-earth-web-plugin' do
  ...
  url 'http://r1---sn-c0q7lns7.c.pack.google.com/edgedl/earth/plugin/current/googleearth-mac-plugin-intel.dmg?redirect_counter=1&cms_redirect=yes&shardbypass=yes',
      user_agent: :fake
