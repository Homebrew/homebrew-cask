cask 'casio-screen-receiver' do
  ...
  url "https://edu.casio.com/education/support_software/dl/screen_Receiver/screenrecv_inst_#{version.before_comma_no_dots}#{version.after_comma_before_colon}_#{version.after_colon}.zip" # 302b should be interpolated from the version
  name 'Casio Screen Receiver'
  homepage 'https://edu.casio.com/education/support_software/'

  pkg "ScreenReceiver_Ver.#{version.before_comma}_#{version.after_comma_before_colon}.pkg"
