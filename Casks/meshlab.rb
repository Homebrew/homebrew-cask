cask 'meshlab' do
  ...
  url "https://downloads.sourceforge.net/project/meshlab/meshlab/MeshLab%20v#{version}/MeshLabMac_v#{version.no_dots}.dmg"
  appcast 'https://sourceforge.net/projects/meshlab/rss',
