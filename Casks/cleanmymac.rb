cask 'cleanmymac' do
  if MacOS.version <= :snow_leopard
    ...
    zap delete: [
                  ...
                  "~/Library/Caches/CleanMyMac #{version.major}",
                  "~/Library/Caches/com.apple.helpd/SDMHelpData/Other/English/HelpSDMIndexFile/com.macpaw.CleanMyMac3.help",
                  ...
                  "~/Library/Preferences/com.macpaw.CleanMyMac#{version.major}.plist",
                  "~/Pictures/Photos Library.photoslibrary/private/com.macpaw.CleanMyMac3",
                ]
  end
