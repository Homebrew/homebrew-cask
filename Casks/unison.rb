cask "unison" do
  if MacOS.version <= :yosemite
    ...
    url "https://github.com/bcpierce00/unison/releases/download/#{version}/unison-#{version}+ocaml-4.11.1+x86_64.macos-10.15.tar.gz, verified: github.com/bcpierce00/unison/"
  else
    version "2.51.3"
