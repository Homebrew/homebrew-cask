cask "remotehamradio" do
  ...
  url "https://s3.amazonaws.com/rhr-electron/desktop-releases/RemoteHamRadio-#{version}-mac.zip", verified: "s3.amazonaws.com/rhr-electron"
  name "RemoteHamRadio"
  ...
  livecheck do
    ...
    strategy :page_match
    regex(%r{href=.*?/RemoteHamRadio-(\d+(?:\.\d+)*)-mac\.zip}i)
  end
