cask "kaleidoscope@beta" do
  version "5.4.3,7987"
  sha256 "d472e34b822e7946850efbec0fa5f2f23758df818f2ba985de4484fc5298770e"

  url "https://updates.kaleidoscope.app/v#{version.major}/beta/Kaleidoscope-#{version.csv.first}-#{version.csv.second}.app.zip"
  name "Kaleidoscope"
  desc "Spot and merge differences in text and image files or folders"
  homepage "https://kaleidoscope.app/"

  livecheck do
    url "https://updates.kaleidoscope.app/v#{version.major}/beta/appcast"
    strategy :sparkle
  end
