cask 'paste' do
  ...
  url "https://rink.hockeyapp.net/api/#{version.major}/apps/ee24d1a939cd4ff8b2861eb8c788a995/app_versions/6?format=zip"
  appcast "https://rink.hockeyapp.net/api/#{version.major}/apps/ee24d1a939cd4ff8b2861eb8c788a995",
