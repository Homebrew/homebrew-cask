cask "pulsar-edit" do
  ...
  on_intel do
    url "https://github.com/pulsar-edit/pulsar/releases/download/v#{version}/Intel.Mac.#{version}.zip",
        verified: "github.com/pulsar-edit/pulsar"
    sha256 "b3350445ea50139849312ad03dc535b4ede20ea47c24fa1564814cbc9a186d0e"
  end
  on_arm do
    url "https://github.com/pulsar-edit/pulsar/releases/download/v#{version}/Silicon.Mac.#{version}.zip",
        verified: "github.com/pulsar-edit/pulsar"
    sha256 "07fb1e91ae99bfbc40833ec19339d05de708e6a41ec4a68c697f2e028490f68d"
  end
