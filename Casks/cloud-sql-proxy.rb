cask 'cloud-sql-proxy' do
  ...
  # storage.googleapis.com/cloudsql-proxy was verified as official when first introduced to the cask
  url "https://storage.googleapis.com/cloudsql-proxy/v#{version}/cloud_sql_proxy.darwin.amd64"
