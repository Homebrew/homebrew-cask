cask 'gambit-c' do
  ...
  if Hardware::CPU.is_32_bit?
    ...
    url "https://www.iro.umontreal.ca/~gambit/download/gambit/v4.7/prebuilt/gambc-v#{version.dots_to_underscores}-macosx-intel32.dmg"
    pkg "gambc-v#{version.dots_to_underscores}-macosx-intel32.pkg"
  else
