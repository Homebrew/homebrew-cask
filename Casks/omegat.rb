cask 'omegat' do
  ...
  url "https://downloads.sourceforge.net/project/omegat/OmegaT%20-%20Standard/OmegaT%20#{version.major_minor}%20%update%20#{version.patch}/OmegaT_#{version}_Mac_Signed.zip"
