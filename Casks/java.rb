cask 'java' do
  ...
  url "http://download.oracle.com/otn-pub/java/jdk/#{version.before_comma}+#{version.after_comma}/c2514751926b4512b076cc82f959763f/jdk-#{version.before_comma}_osx-x64_bin.dmg",
      cookies: {
