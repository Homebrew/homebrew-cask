cask 'teamdrive' do
  ...
  # s3download.teamdrive.net.s3.amazonaws.com/4.2.1547/TMDR/mac-10.10.5/Install-TeamDrive-4.2.1.1547_TMDR.dmg was verified as official when first introduced to the cask
  url 'http://s3download.teamdrive.net.s3.amazonaws.com/4.2.1547/TMDR/mac-10.10.5/Install-TeamDrive-4.2.1.1547_TMDR.dmg'
  name 'TeamDrive'
  homepage 'https://www.teamdrive.com/'
  license :closed

  installer script: 'Install-TeamDrive-4.2.1.1547_TMDR.app/Contents/MacOS/osx-intel',
