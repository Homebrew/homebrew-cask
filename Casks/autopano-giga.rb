cask 'autopano-giga' do
  ...
  url "http://cdn-download.kolor.com/apg/#{version.before_comma}_#{version.after_comma}/AutopanoGiga_Mac_#{version.major_minor_patch_no_dots}_#{version.after_comma}.dmg"
  name 'Autopano Giga'
