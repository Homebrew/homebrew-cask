cask "xournal++" do
  file_ending = on_arch_conditional arm: "macos-arm.dmg", intel: "macos.zip"
  ...
  url "https://github.com/xournalpp/xournalpp/releases/download/v#{version}/xournalpp-#{version}-#{file_ending}"
  name "Xournal++"
