cask 'splashtop-business' do
  ...
  # d17kmd0va0f0mp.cloudfront.net/macclient/STB/Splashtop_Business_Mac_INSTALLER_v3.1.8.0.dmg was verified as official when first introduced to the cask
  url 'https://d17kmd0va0f0mp.cloudfront.net/macclient/STB/Splashtop_Business_Mac_INSTALLER_v3.1.8.0.dmg'
