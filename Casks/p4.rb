cask 'p4' do
  ...
  if Hardware::CPU.is_32_bit?
    ...
    url "http://filehost.perforce.com/perforce/r#{version.sub(%r{\A20(\d\d\.\d+).*}, '\1')}/bin.macosx105x86/p4"
  else
    sha256 '85153a60d75d84b172320e0d9348d0da67979f24a2e63650e5febf005afac778'
    url "http://filehost.perforce.com/perforce/r#{version.sub(%r{\A20(\d\d\.\d+).*}, '\1')}/bin.macosx105x86_64/p4"
  end
