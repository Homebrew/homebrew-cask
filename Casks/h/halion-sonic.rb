cask "halion-sonic" do
  ...
  name "HALion Sonic #{version.csv.first.major}"
  desc "Player for sample libraries, synthesizers and hybrid instruments"
  homepage "https://o.steinberg.net/en/support/downloads/halion_sonic_#{version.csv.first.major}.html"

  livecheck do
    url :homepage
    regex(%r{href=.*/sda_downloads/([^/]+)/Halion[._-]Sonic[._-]v?(\d+(?:\.\d+)+)[._-]Installer[._-]mac\.dmg}i)
