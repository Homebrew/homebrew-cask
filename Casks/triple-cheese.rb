cask 'triple-cheese' do
  ...
  url "https://uhedownloads-heckmannaudiogmb.netdna-ssl.com/releases/TripleCheese_#{version.major_minor_patch.dots_to_underscores}_Mac.zip"
  name 'Triple Cheese'
  homepage 'https://u-he.com/products/triplecheese/'

  pkg "TripleCheese#{version.split('.')[3]}Mac/TripleCheese #{version} Installer.pkg"
