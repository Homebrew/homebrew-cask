cask 'vistrails' do
  ...
  url "https://downloads.sourceforge.net/project/vistrails/vistrails/v#{version.sub(%r{-.*}, '')}/vistrails-mac-10.6-intel-#{version}.dmg"
  appcast 'https://sourceforge.net/projects/vistrails/rss',
