...
#    sha256 '68094b55122af0f441c1afa15f66bece74ddf57f280de7e6a504414c10e74644'
#    'ca-valencia'
#  end
  ...
  preflight do
    system '/usr/bin/sudo', '-E', '--', '/usr/bin/tar', '-C', '/Applications/LibreOffice.app/', '-xjf', "#{staged_path}/LibreOffice Language Pack.app/Contents/tarball.tar.bz2"
    system '/usr/bin/sudo', '-E', '--', '/usr/bin/touch', '/Applications/LibreOffice.app/Contents/Resources/extensions'
  end
