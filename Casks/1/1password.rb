cask "1password" do
  ...
  version "8.10.68"
  sha256 arm:   "6e19aecbc814542bfe858488a585e09bc6b47f5f89b7229be20e5c5082426f6f",
         intel: "b7f8253ef106247f88718cab9d6d1f31211e2c1f262aa1aa999f309d5142269a"
  ...
  livecheck do
    ...
    regex(%r{href=.*?/1Password[._-]?v?(\d+(?:\.\d+)+)(?:[._-]\d+[._-]?PRODUCTION)?\.zip}i)
  end
