cask 'fontforge' do
  version '20190317,2019-03-17-1d421d1'
  ...
  url "https://github.com/fontforge/fontforge/releases/download/#{version.before_comma}/FontForge-#{version.after_comma}.app.dmg"
