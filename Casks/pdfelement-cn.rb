cask 'pdfelement-cn' do
  ...
  url "http://cc-download.wondershare.cc/cbs_down/mac-pdfelement_full#{version.after_comma}.dmg"
  appcast 'https://cbs.wondershare.com/go.php?m=upgrade_info&pid=5385'
  name '万兴PDF专家'
