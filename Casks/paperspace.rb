cask 'paperspace' do
  ...
  appcast 'https://www.macupdater.net/cgi-bin/extract_text/extract_text_split.cgi?splitters=[]&url=https://www.paperspace.com/download&headers={%22User-Agent%22:%22Mozilla/5.0%20(Macintosh%3B%20Intel%20Mac%20OS%20X%2010_14_5)%22}'
  name 'Paperspace'
