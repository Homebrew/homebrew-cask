cask "chef-workstation" do
  ...
  sha256_intel = "b957dca3a7be28373a718e95f88290c5be928985ac08b37b8c83b1ac1330d4db"
  sha256_arm = "728ff9458a7f73618a9a34ccd5cb41962ce061f2d67ef2e58e19dd0251c528a5"

  version "22.1.778"

  if Hardware::CPU.intel?
    sha256 sha256_intel.to_s
  else
    sha256 sha256_arm.to_s
  end
