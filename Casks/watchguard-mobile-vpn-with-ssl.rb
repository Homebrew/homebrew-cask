cask 'watchguard-mobile-vpn-with-ssl' do
  ...
  url "http://cdn.watchguard.com/SoftwareCenter/Files/MUVPN_SSL/#{version.major_minor.dots_to_underscores}/WG-MVPN-SSL_11_#{version.major_minor.dots_to_underscores}.dmg"
