cask 'cocoa-weather' do
  ...
  # github.com/zhs852/Cocoa-Weather was verified as official when first introduced to the cask
  url "https://github.com/zhs852/Cocoa-Weather/releases/download/#{version}/Cocoa-Weather-#{version}.dmg"
