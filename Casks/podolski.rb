cask 'podolski' do
  ...
  url "https://uhedownloads-heckmannaudiogmb.netdna-ssl.com/releases/Podolski_#{version.major_minor_patch.dots_to_underscores}_Mac.zip"
  name 'Podolski'
  homepage 'https://u-he.com/products/podolski/'

  pkg "Podolski#{version.split('.')[3]}Mac/Podolski #{version} Installer.pkg"
