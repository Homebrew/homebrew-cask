...
describe Hbc::Artifact::Uninstall do
  ...
  describe 'uninstall_phase' do
    ...
    it 'runs the specified uninstaller for the Cask' do
      ...
      Hbc::FakeSystemCommand.expects_command(['/usr/bin/sudo', '-E', '--', '/usr/bin/osascript', '-e', 'tell application "System Events" to delete every login item whose name is "Fancy"'])
