...
The confirmation of the updated `sha256` should ideally be publicly available. Specifically:
 ...
 - By codesigning
   - If the Cask is an `.app` that is [codesigned](https://developer.apple.com/legacy/library/documentation/Darwin/Reference/ManPages/man1/codesign.1.html) (in a `.dmg` or `.zip` container) it can be uploaded and verified using [VirusTotal](https://www.virustotal.com/). Example [(Brave-0.15.2.dmg)](https://www.virustotal.com/en/file/56ef38654223c910dd8219fce426e27b613eedb900608304c260021f7f774210/analysis/)
