...
- Ask the developer to publicly confirm the new checksum and provide a link to this confirmation in your pull request. As examples, confirmation can be acheived by opening an issue of the project’s GitHub, or asking on the developer’s Twitter. Note that a link to an upstream page with a checksum is never sufficient, as a malicious third-party who could modify the download could also modify checksums on the page.
