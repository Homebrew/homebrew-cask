...
| `language`             | required                      | a Ruby block, called with language code parameters, containing other stanzas and/or a return value (see also [Binary Language Details](stanzas/language.md))
