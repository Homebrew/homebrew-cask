...
| `livecheck`            | no                            | Ruby block containing information on how to find updates for this Cask.<br />See [Livecheck Stanza Details](stanzas/livecheck.md) for more information.
