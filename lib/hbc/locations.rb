module Hbc::Locations
  ...
  module ClassMethods
    ...
    def audiounit_plugindir
      @audiounit_plugindir ||= Pathname.new('~/Library/Audio/Plug-Ins/Components').expand_path
    end

    def audiounit_plugindir=(_audiounit_plugindir)
      @audiounit_plugindir = _audiounit_plugindir
    end
